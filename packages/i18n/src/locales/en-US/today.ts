...
export const today = {
  ...
  dailyBriefAttention: 'Needs attention',
  dailyBriefCount: '{{count}} items surfaced from your workspace',
  dailyBriefUpdated: 'Updated just now',
  dailyBriefQuietLabel: 'Quiet',
  portfolioExposureDetail: '{{percent}}% of portfolio',
  portfolioExposureNote: '{{percent}}% portfolio exposure',
  manage: 'Manage',
  hide: 'Hide',
