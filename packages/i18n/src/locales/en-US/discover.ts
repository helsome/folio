...
export const discover = {
  ...
  rerun: 'Rerun',
  runningHint: 'Screening {{scope}}…',
  security: 'Security',
  price: 'Price',
  change: 'Change',
  more: 'More',
  providerWarning: 'Some market data may be unavailable',
  providerWarningDetail: 'The market-data connection may not be configured, so results could be incomplete.',
  goToConnections: 'Go to connection settings',
  failureDetails: 'Show {{count}} failure detail…',
  failureDetails_other: 'Show {{count}} failure details…',
  partialData: 'Partial data — some sources failed this run, so results may be incomplete.',
  emptyTry1: 'Change the screening conditions',
  emptyTry2: 'Add more watchlist symbols',
  emptyTry3: 'Check the market-data connection',
  metric: {
    change: 'Change',
    price: 'Price',
    volume: 'Volume',
