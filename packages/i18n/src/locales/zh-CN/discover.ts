...
export const discover = {
  ...
  back: '返回机会发现',
  rerun: '重新运行',
  runningHint: '正在筛选{{scope}}…',
  security: '证券',
  price: '现价',
  change: '涨跌幅',
  more: '更多',
  providerWarning: '部分行情数据可能不可用',
  providerWarningDetail: '市场行情连接可能尚未配置，本次结果可能不完整。',
  goToConnections: '前往连接设置',
  failureDetails: '显示 {{count}} 条失败详情…',
  failureDetails_other: '显示 {{count}} 条失败详情…',
  partialData: '数据不完整——本次部分数据源失败，结果可能不完整。',
  emptyTry1: '更换筛选条件',
  emptyTry2: '增加自选标的',
  emptyTry3: '检查行情连接',
  metric: {
