...
export const ThesisEditor: React.FC<{
  ...
  return (
    <div className="space-y-3 rounded-[10px] border border-foreground/8 p-3">
      ...
      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-foreground/70">Core thesis</span>
        <textarea
          value={summary}
      ...
      <div className="grid grid-cols-2 gap-2">
        <ListField label="Bull case" value={bullCase} onChange={setBullCase} placeholder="One point per line" />
        <ListField label="Bear case" value={bearCase} onChange={setBearCase} placeholder="One point per line" />
        <ListField label="Catalysts" value={catalysts} onChange={setCatalysts} placeholder="One point per line" />
        <ListField label="Risks" value={risks} onChange={setRisks} placeholder="One point per line" />
      </div>

      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-foreground/70">Target price (optional)</span>
        <input
          value={targetPrice}
