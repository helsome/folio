...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="folio-sidebar flex h-full min-w-0 bg-surface-muted">
      <nav aria-label={t('navigation.globalNavAria')} className="folio-sidebar-rail flex w-16 shrink-0 flex-col items-center border-r border-border bg-surface-muted px-2 py-2">
        <button type="button" aria-label={t('navigation.homeAria')} onClick={() => setNavSection('today')} className="folio-sidebar-logo mb-5 flex h-9 w-9 items-center justify-center overflow-hidden rounded-[10px] bg-surface shadow-sm">
      ...
      <div className="folio-sidebar-pane flex min-w-0 flex-1 flex-col">
        <div className="folio-sidebar-pane-header flex h-12 shrink-0 items-center justify-between border-b border-border px-3">
        ...
        {(navSection === 'sessions' || navSection === 'watchlist' || navSection === 'research') && (
          <section className="folio-sidebar-watchlist flex min-h-0 flex-[1.25] flex-col overflow-hidden">
